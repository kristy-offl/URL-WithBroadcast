...
#################################
    ...
    FORMAT_SELECTION = "<i>Select The Desired Format</i>\n\n<i>🎞 - Stream Format (Left Side)</i>\n<i>📁 - File format (Right Side)</i>\n\n<i>If You Want To Set Custom Thumbnail, Send Photo Or Use Auto-Generated Thumbnail.</i>"
    ...
    CUSTOM_CAPTION_UL_FILE = "**Share :- @HiroshiBots**"
    NO_CUSTOM_THUMB_NAIL_FOUND = "**Sed No Custom ThumbNail found.**"
